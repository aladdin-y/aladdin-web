    ...
    return (
                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                ...
                                <p className="font-semibold text-xl text-white">Aladdin</p>
                            </div>
                            <div className="relative mt-1 inline-block text-left">
                            <p className="animateHeader text-white text-opacity-50 text-left mt-5">
        Aladdin, a proficient programmer with two years of experience. My expertise includes developing advanced Discord bots and comprehensive full-stack web applications.
                        ...
                        <div className="col-span-1">
                            ...
                            <div>
                                <Link href="/soon">
                                    <a className="text-white/50 text-sm hover:text-white hover:underline transform duration-200">
                                    Become a Partner
                                    </a>
                                </Link>
                            </div>
                            ...
                            <div>
                                <a href="https://discord.gg/4Kk6KBkxVV" target="_blank" className="text-white/50 hover:text-white hover:underline transform duration-200">
                                    Support Server
                                </a>
                            </div>
                            <div>
